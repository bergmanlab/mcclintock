...
then
	...
	bwa mem -t $processors -v 0 $reference_genome $fastq1 $fastq2 > $samplefolder/sam/$sample.sam
...
then
	...
	bash runtelocate.sh $sam_folder $reference_genome $telocate_te_locations 2 $sample $median_insertsize $samplefolder
