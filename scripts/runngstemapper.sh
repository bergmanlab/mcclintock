...
then
	...
	awk -F'[\t;]' -v sample=$3 '{print $1"\t"$2"\t"$3"\t"$6"_"$9"_"sample"_ngs_te_mapper_sr_"NR"\t0\t"$5}' $sample_name/analysis/bed_tsd/$sample_name"_1_"$fasta2"insertions.bed" > $sample_name/$3"_ngs_te_mapper_presort.bed"
