...
then
	...
	awk -F'[\t/]' '{printf $1"\t"; if($17=="old") printf $2-1"\t"$2+$3"\t"$5"_"$17"\t0"; else if($17=="new") printf $2-1"\t"$2-1"\t"$5"_"$17"\t0"; if($14=="parallel") print "\t+"; else if($14 =="uncertain") print "\t."; else print "\t-";}' tmpfile >> $5/$5"_telocate_presort.bed"
