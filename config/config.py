...
INTERMEDIATE_PATHS = {
        ...
        'masked_fasta' : REF_DIR+"genome_fasta/"+REF_NAME+".masked.fasta",
        'popoolationTE_ref_fasta' : REF_DIR+"genome_fasta/"+REF_NAME+".masked.popoolationTE.fasta",
        'telocate_ref_fasta' : REF_DIR+"genome_fasta/"+REF_NAME+".aug.telocate.fasta",
        'ref_2bit' : REF_DIR+"genome_fasta/"+REF_NAME+".aug.fasta.2bit",
        'consensus' : REF_DIR+"consensus_fasta/consensusTEs.fasta",
        'relocaTE_consensus' : REF_DIR+"consensus_fasta/formattedConsensusTEs.relocaTE.fasta",
        ...
        'telocate_te_gff' : REF_DIR+"reference_te_locations/inrefTEs_HL.gff",
        'ref_tes_bed' : REF_DIR+"reference_te_locations/"+REF_NAME+".ref.TEs.bed",
        'relocaTE_ref_TEs' : REF_DIR+"reference_te_locations/"+REF_NAME+".ref.TEs.relocaTE.gff",
        'popoolationTE_gff' : REF_DIR+"reference_te_locations/"+REF_NAME+".ref.TEs.popoolationTE.gff",
        'taxonomy' : REF_DIR+"te_taxonomy/taxonomy.tsv",
        'unaugmented_taxonomy' : REF_DIR+"te_taxonomy/unaugmented_taxonomy.tsv",
        'popoolationTE_taxonomy' : REF_DIR+"te_taxonomy/taxonomy.popoolationTE.tsv",
        'coverage_fasta' : REF_DIR+"coverageTEs.fasta",
        'ref_te_fasta' : REF_DIR+REF_NAME+".ref.TEs.fasta",
