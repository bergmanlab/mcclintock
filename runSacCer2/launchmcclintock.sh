...
if [ -z ../sacCer2/$sample_name/ ]; then
	...
	if [ -z ../sacCer2/$sample_name/$sample_name"_relocate.bed" || -z ../sacCer2/$sample_name/$sample_name"_ngs_te_mapper.bed" || -z ../sacCer2/$sample_name/$sample_name"_retroseq.bed" || -z ../sacCer2/$sample_name/$sample_name"_telocate.bed" || -z ../sacCer2/$sample_name/$sample_name"_popoolationte.bed" ]; then
